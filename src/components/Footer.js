...
<footer id="footer" className="border-0 mt-0">
    <div className="container py-3">
        <div className="row text-center text-md-start my-5">
            <div className="col-md-6 col-lg-3 text-center text-md-start mb-5 mb-lg-0 column1 my-0">
                <a href="\"
                    className="text-decoration-none">
                    <img src={logowhite} className="img-fluid" alt="" />
                </a>
                <p>
                    Many desktop publishing packages web page editors now is use model search for many web
                    sites.
                </p>
                <ul className="social-icons social-icons-medium">
                    <li className="social-icons-instagram">
                        <a href="\" className="no-footer-css" target="_blank"
                    ...
                    <li className="social-icons-facebook">
                        <a href="\" className="no-footer-css" target="_blank"
                            title="Facebook"><i className="fa fa-facebook-f"></i></a>
                    </li>
                </ul>
            </div>
            ...
            <div className="col-md-6 col-lg-4 mb-5 mb-md-0">
                ...
                <div
                    ...
                    <div className="feature-box-info line-height-1 ps-2">
                        ...
                        <p>No.1, kuppuswamy Nayakkar Street, GST Main Road, Guduvanchery, Chennai 603202.</p>
                    </div>
                </div>
            </div>
            <div className="col-md-12 mb-5 mb-md-0">
                <div
                    className="feature-box flex-column flex-xl-row align-items-center align-items-lg-start text-center text-lg-start">
                    <div className="feature-box-icon bg-transparent mb-4 mb-xl-0 p-0">
                        <i className="icons fa fa-phone text-5 text-color-light position-relative top-4"></i>
                    </div>
                    <div className="feature-box-info line-height-1 ps-2">
            ...
            <div className="col-md-6 col-lg-2">
                <h5 className="text-transform-none font-weight-bold text-color-light text-4-5 mb-4">Opening Hours
                </h5>
    ...
    <div className="footer-copyright bg-light py-1">
        <div className="container py-2">
            <div className="row">
                <div className="col">
                    <p className="text-center text-3 mb-0">Copyright © 2023. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
